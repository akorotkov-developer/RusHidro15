...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'btnUnmount': 'Размонтировать', // added 30.04.2012
			'btnConv'   : 'Конвертировать', // added 08.04.2014
			'btnCwd'    : 'Папка',      // from v2.1 added 22.5.2015
			'btnVolume' : 'Диск',    // from v2.1 added 22.5.2015
			'btnAll'    : 'Везде',       // from v2.1 added 22.5.2015
			'btnMime'   : 'MIME тип', // from v2.1 added 22.5.2015
			'btnFileName':'Название',  // from v2.1 added 22.5.2015
