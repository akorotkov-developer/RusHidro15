...
//  email : fuushikaden@yahoo.com
  ...
  if (dom)
  {
    ...
    document.write ("<div onclick='bShow=true' id='calendar'  style='z-index:+999;position:absolute;visibility:hidden;'><table  width="+
                    ...
                    " style='font-family:verdana;font-size:12px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:verdana; font-size:12px}' bgcolor='#ffffff'>"+
                    "<tr bgcolor='#004C80'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:verdana;font-size:12px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a onclick='javascript:hideCalendar();return false;' href='#'><IMG SRC='"+imgDir+"calendar_close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Закрыть календарь' /></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
  ...
  function constructMonth() {
    ...
    if (!monthConstructed) {
      ...
      document.getElementById("selectMonth").innerHTML = "<table width=70 style='font-family:verdana; font-size:12px; border-width:1; border-style:solid; border-color:#a0a0a0;' bgcolor='#f3f3f3' cellspacing=0 onmouseover='clearTimeout(timeoutID1)' onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" + sHTML + "</table>"
  ...
  function constructYear() {
    ...
    if (!yearConstructed) {
      ...
      document.getElementById("selectYear").innerHTML = "<table width=44 style='font-family:verdana; font-size:12px; border-width:1; border-style:solid; border-color:#a0a0a0;' bgcolor='#f3f3f3' onmouseover='clearTimeout(timeoutID2)' onmouseout='clearTimeout(timeoutID2);timeoutID2=setTimeout(\"popDownYear()\",100)' cellspacing=0>" + sHTML + "</table>"
  ...
  function popUpCalendar(ctl, ctl2, format, mode) {
	...
	//тупые баги эксплорера
/*
	if (ctl)	{
	    var leftpos=300;
		var toppos=0;
		ctl = document.formday;
	}
*/
